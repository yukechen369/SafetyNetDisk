...
public class Main_Window extends JFrame
{
	...
	public Main_Window(String Username)// 主界面
	{
		Init();
		AddTitle();
		AddTable();
	...
	private void Init()
	{
		...
		UpPanel = new JPanel()
		{
			public void paintComponent(Graphics g)
			{
				...
				g.fillRect(10, 110, 100, 25);
				g.setColor(Color.GREEN);
				g.fillRect(10, 110, (int) (CapacityPercent * 1), 25);
			}
		};
		...
		RoutePane.setBounds(120, 0, 820, 45);
	...
	private void AddTitle()
	{
		...
		//UpPanel.add(Image);
		//buotlogo
		 ico = new ImageIcon("BUPTlogo1.png");
		Image = new JLabel(ico);
		Image.setBounds(5, 15, 110, 27);
		UpPanel.add(Image);
		// 标题
		...
		// 容量的字
		Capacity = new JLabel();
		Capacity.setBounds(10, 113, 110, 20);
	...
	private void AddTable()
	{
		...
		TableHeadPane.setBounds(120, 45, 820, 40);
		...
		ScrollPane.setBounds(120, 95, 820, 408);
	...
	private void AddSearchText()
	{
		...
		SearchText.setBounds(580, 10, 200, 30);
	...
	{
		// 添加昵称
		Nickname = new JLabel("ydd", JLabel.CENTER);
		Font f = new Font("楷体", Font.BOLD, 22);
		Nickname.setFont(f);
		Nickname.setBounds(0, 75, 120, 40);
		Nickname.setBackground(new Color(245,245,220));
		...
		Nickname.addMouseListener(new MouseAdapter()
		{
			...
			public void mousePressed(MouseEvent e)
			{
				Nickname.setLocation(0, 77);
			}
			public void mouseReleased(MouseEvent e)
			{
				Nickname.setLocation(0, 75);
			}
		});
	}
	...
	{
		MyDisk = new JPanel();
		MyDisk.setLayout(new FlowLayout());
		MyDisk.setBackground(new Color(245,245,220));
		...
		MyDisk.addMouseListener(new MouseAdapter()
		{
			...
			public void mousePressed(MouseEvent e)
			{
				MyDisk.setLocation(0, 182);
				MyDisk.setBackground(new Color(218,165,32));
			}
			public void mouseReleased(MouseEvent e)
			{
				MyDisk.setLocation(0, 180);
				MyDisk.setBackground(new Color(245,245,220));
			}
...
//				TranList.add(Image);
	...
	private void AddUpload()
	{
		...
		Upload.setBackground(new Color(245,245,220));

		

		JLabel Label = new JLabel("上传文件");
		Font f = new Font("微软雅黑", Font.BOLD, 13);
		Label.setFont(f);
		Label.setBounds(18, 53, 60, 20);
		Label.setForeground(new Color(128,128,0));
		Upload.add(Label);
		Upload.setBounds(0, 240, 120, 35);
		...
		Upload.addMouseListener(new MouseAdapter()
		{
			...
			public void mousePressed(MouseEvent e)
			{
				Upload.setLocation(0, 242);
				Upload.setBackground(new Color(218,165,32));
			}
			public void mouseReleased(MouseEvent e)
			{
				Upload.setLocation(0, 240);
				Upload.setBackground(new Color(245,245,220));
			}
	...
	private void AddDownload()
	{
		...
		Download.setBackground(new Color(245,245,220));


		JLabel Label = new JLabel("下载文件");
		Font f = new Font("微软雅黑", Font.BOLD, 13);
		Label.setFont(f);
		Label.setBounds(18, 53, 60, 20);
		Label.setForeground(new Color(128,128,0));
		Download.add(Label);
		Download.setBounds(0, 300, 120, 35);
		...
		Download.addMouseListener(new MouseAdapter()
		{
			...
			public void mousePressed(MouseEvent e)
			{
				Download.setLocation(0, 302);
				Download.setBackground(new Color(218,165,32));
			}
			public void mouseReleased(MouseEvent e)
			{
				Download.setLocation(0, 300);
				Download.setBackground(new Color(245,245,220));
			}
	...
	{
		Share = new JPanel();
		Share.setLayout(new FlowLayout());
		Share.setForeground(Color.WHITE);
		Share.setBackground(new Color(245,245,220));

		

		JLabel Label = new JLabel("分享文件");
		Font f = new Font("微软雅黑", Font.BOLD, 13);
		Label.setFont(f);
		Label.setBounds(18, 53, 60, 20);
		Label.setForeground(new Color(128,128,0));
		Share.add(Label);
		Share.setBounds(0, 300, 120, 35);
		//UpPanel.add(Share);
		Share.addMouseListener(new MouseAdapter()
				{
					...
					public void mousePressed(MouseEvent e)
					{
						Share.setLocation(0, 302);
					}
					public void mouseReleased(MouseEvent e)
					{
						Share.setLocation(0, 300);
					}
					public void mouseClicked(MouseEvent e)
					{
	...
	private void AddDelete()
	{
		...
		Delete.setBackground(new Color(245,245,220));

		

		JLabel Label = new JLabel("删除文件");
		Font f = new Font("微软雅黑", Font.BOLD, 13);
		Label.setFont(f);
		Label.setBounds(18, 53, 60, 20);
		Label.setForeground(new Color(128,128,0));
		Delete.add(Label);
		Delete.setBounds(0, 360, 120, 35);
		Delete.addMouseListener(new MouseAdapter()
		{
			...
			public void mousePressed(MouseEvent e)
			{
				Delete.setLocation(0, 362);
				Delete.setBackground(new Color(218,165,32));
			}
			public void mouseReleased(MouseEvent e)
			{
				Delete.setLocation(0, 360);
				Delete.setBackground(new Color(245,245,220));
			}
	...
	private void AddNewFolder()
	{
		...
		NewFolder.setLayout(new FlowLayout());
		NewFolder.setForeground(Color.WHITE);
		NewFolder.setBackground(new Color(245,245,220));
		...
		Label.setForeground(new Color(128,128,0));
		NewFolder.add(Label);
		NewFolder.setBounds(0, 420, 120, 35);
		...
		NewFolder.addMouseListener(new MouseAdapter()
		{
			...
			public void mousePressed(MouseEvent e)
			{
				NewFolder.setLocation(0, 422);
				NewFolder.setBackground(new Color(218,165,32));
			}
			public void mouseReleased(MouseEvent e)
			{
				NewFolder.setLocation(0, 420);
				NewFolder.setBackground(new Color(245,245,220));
			}
		...
		Nickname.addKeyListener(new KeyAdapter()
		{
			public void keyTyped(KeyEvent arg0)
			{
				if (arg0.getKeyChar() == '\n')
				{
					...
					{
						new Thread(new Create_New_Nickname(Username,Nickname.getText())).start();
						Dialog.dispose();
					} else
					{
						tip.setForeground(Color.RED);
	...
	private void AddTranList()
	{
		...
		//TranList.setBackground(new Color(245,245,220));
	...
	private void AddOneFile(String Filename, String Size, String ModTime, int location)
	{
		...
		shareButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				//new ShareWindow("www.baidu.com","292329");
			}
		});
