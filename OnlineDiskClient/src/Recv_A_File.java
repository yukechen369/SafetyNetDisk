...
public class Recv_A_File implements Runnable
{
	...
	String Route = null;
	public String DefaultDownloadRoute = "D:\\OnlineDiskLadyDownload";
	Main_Window mainwindow = null;
	JProgressBar bar = null;
	
	public Recv_A_File(Socket socket,Main_Window mainwindow,String data)
	{
		this.socket = socket;
	...
	public void Recv()
	{
		...
		try
		{
			...
			{
				RecvByte = AES_ECB.decrypt(RecvByte, cKey);//= rc.rc4(RecvByte,"123");
